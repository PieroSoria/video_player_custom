...
class AVFoundationVideoPlayerApiSetup {
  ...
  static func setUp(
    ...
    let initializeChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.video_player_custom_avfoundation.AVFoundationVideoPlayerApi.initialize\(channelSuffix)",
    ...
    let createForPlatformViewChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.video_player_custom_avfoundation.AVFoundationVideoPlayerApi.createForPlatformView\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let createForTextureViewChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.video_player_custom_avfoundation.AVFoundationVideoPlayerApi.createForTextureView\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMixWithOthersChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.video_player_custom_avfoundation.AVFoundationVideoPlayerApi.setMixWithOthers\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getAssetUrlChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.video_player_custom_avfoundation.AVFoundationVideoPlayerApi.getAssetUrl\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
