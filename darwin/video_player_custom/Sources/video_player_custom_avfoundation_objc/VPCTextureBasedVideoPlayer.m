...
#import "./include/video_player_custom_avfoundation_objc/VPCTextureBasedVideoPlayer.h"
#import "./include/video_player_custom_avfoundation_objc/VPCTextureBasedVideoPlayer_Test.h"

@interface VPCTextureBasedVideoPlayer ()
// The updater that drives callbacks to the engine to indicate that a new frame is ready.
@property(nonatomic) VPCFrameUpdater *frameUpdater;
// The display link that drives frameUpdater.
@property(nonatomic) NSObject<VPCDisplayLink> *displayLink;
...
@implementation VPCTextureBasedVideoPlayer
