...
/// VPCFrameUpdater is responsible for notifying the Flutter texture registry
/// when a new video frame is available.
@interface VPCFrameUpdater : NSObject
...
/// Initializes a new instance of VPCFrameUpdater with the given Flutter texture registry.
