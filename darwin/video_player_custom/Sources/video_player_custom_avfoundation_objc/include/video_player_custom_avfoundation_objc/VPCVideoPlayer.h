...
#import "VPCAVFactory.h"
#import "VPCVideoEventListener.h"
...
/// VPCVideoPlayer manages video playback using AVPlayer.
...
/// texture, use VPCTextureBasedVideoPlayer instead.
@interface VPCVideoPlayer : NSObject <VPCVideoPlayerInstanceApi>
...
@property(nonatomic, nullable) NSObject<VPCVideoEventListener> *eventListener;
/// A block that will be called when dispose is called.
@property(nonatomic, nullable, copy) void (^onDisposed)(void);

/// Initializes a new instance of VPCVideoPlayer with the given AVPlayerItem, AV factory, and view
/// provider.
