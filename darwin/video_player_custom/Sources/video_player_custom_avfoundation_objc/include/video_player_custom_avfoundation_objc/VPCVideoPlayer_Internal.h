...
@interface VPCVideoPlayer ()
/// The pixel buffer source associated with this video player.
@property(nonatomic, readonly) NSObject<VPCPixelBufferSource> *pixelBufferSource;
/// The view provider, to obtain view information from.
@property(nonatomic, readonly, nullable) NSObject<VPCViewProvider> *viewProvider;
