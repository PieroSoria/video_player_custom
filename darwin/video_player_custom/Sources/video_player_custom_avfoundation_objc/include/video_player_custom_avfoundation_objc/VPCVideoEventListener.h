...
/// Handles event/status callbacks from VPCVideoPlayer.
///
/// This is an abstraction around the event channel to avoid coupling VPCVideoPlayer directly to
/// implementation details specific to the plugin communication method.
@protocol VPCVideoEventListener <NSObject>
@required
