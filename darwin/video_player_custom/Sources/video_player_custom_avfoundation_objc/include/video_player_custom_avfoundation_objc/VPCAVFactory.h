...
@protocol VPCPixelBufferSource <NSObject>
@required
...
@protocol VPCAVPlayerItem <NSObject>
@required
/// Wraps the underlying playerItem's asset property.
@property(nonatomic, readonly) NSObject<VPCAVAsset> *asset;
...
@protocol VPCAVAudioSession <NSObject>
@required
...
/// A default implementation of the VPCAVFactory protocol, using real AVFoundation objects.
@interface VPCDefaultAVFactory : NSObject <VPCAVFactory>
@end
